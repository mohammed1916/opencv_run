...
int main(int argc, char** argv) {
    ...
    cout << "Loading FastSAM classification model for feature-based segmentation..." << endl;
    
    // string modelPath = "models/mobilevit/model.onnx"; 
    string modelPath = "models/fastsam/model.onnx/model.onnx"; 
    ...
    try {
        if (filesystem::exists(modelPath)) {
            ...
            if (!net.empty()) {
                modelLoaded = true;
                cout << "Successfully loaded FastSAM model: " << modelPath << endl;
                cout << "Note: This is a classification model, will be used for feature extraction" << endl;
            }
        } else {
            cout << "FastSAM model not found at: " << modelPath << endl;
        }
    } catch (const Exception& e) {
        cout << "Failed to load FastSAM model: " << e.what() << endl;
    }
    ...
    cout << "Performing feature-based segmentation with FastSAM..." << endl;
